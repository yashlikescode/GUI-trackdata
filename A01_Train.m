...
% Velocity
Train.vel = 80/3.6;          % Train velocity [m/s]
...
% veh_num = 3; run([TrainProp_Train.Load.path,'Eurostar_EC2_EC8']);
% veh_num = 4; run([TrainProp_Train.Load.path,'Eurostar_EC2_EC8']);
% veh_num = 5; run([TrainProp_Train.Load.path,'Eurostar_EC2_EC8']);
% veh_num = 6; run([TrainProp_Train.Load.path,'Eurostar_EC2_EC8']);
% veh_num = 7; run([TrainProp_Train.Load.path,'Eurostar_EC2_EC8']);
% veh_num = 8; run([TrainProp_Train.Load.path,'Eurostar_EC2_EC8']);
% veh_num = 9; run([TrainProp_Train.Load.path,'Eurostar_EC2_EC8']);
% veh_num = 10; run([TrainProp_Train.Load.path,'Eurostar_EC9']);
% veh_num = 11; run([TrainProp_Train.Load.path,'Eurostar_Locomotive']);
